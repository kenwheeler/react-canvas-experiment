...
export const drawChild = ({ ctx, child, offset = { x: 0, y: 0 } }) => {
  ...
  if (child.type === 'View') {
    ...
    if (props.style.borderWidth) {
      ...
      ctx.strokeRect(offsetLeft + props.style.borderWidth / 2, offsetTop + props.style.borderWidth / 2, width - props.style.borderWidth, height - props.style.borderWidth);
    }
    if (props.style.borderBottomWidth) {
      ctx.strokeStyle = props.style.borderBottomColor || props.style.borderColor || 'transparent';
      ctx.lineWidth = props.style.borderBottomWidth || 0;
      ctx.beginPath();
      ctx.moveTo(offsetLeft, offsetTop + height - props.style.borderBottomWidth / 2);
      ctx.lineTo(offsetLeft + width, offsetTop + height - props.style.borderBottomWidth / 2);
      ctx.stroke();
    }
    if (props.style.borderTopWidth) {
      ctx.strokeStyle = props.style.borderTopColor || props.style.borderColor || 'transparent';
      ctx.lineWidth = props.style.borderTopWidth || 0;
      ctx.beginPath();
      ctx.moveTo(offsetLeft, offsetTop + props.style.borderTopWidth / 2);
      ctx.lineTo(offsetLeft + width, offsetTop + props.style.borderTopWidth / 2);
      ctx.stroke();
    }
    if (props.style.borderLeftWidth) {
      ctx.strokeStyle = props.style.borderLeftColor || props.style.borderColor || 'transparent';
      ctx.lineWidth = props.style.borderLeftWidth || 0;
      ctx.beginPath();
      ctx.moveTo(offsetLeft + props.style.borderLeftWidth / 2, offsetTop);
      ctx.lineTo(offsetLeft + props.style.borderLeftWidth / 2, offsetTop + height);
      ctx.stroke();
    }
    if (props.style.borderRightWidth) {
      ctx.strokeStyle = props.style.borderRightColor || props.style.borderColor || 'transparent';
      ctx.lineWidth = props.style.borderRightWidth || 0;
      ctx.beginPath();
      ctx.moveTo(offsetLeft + width - props.style.borderRightWidth / 2, offsetTop);
      ctx.lineTo(offsetLeft + width - props.style.borderRightWidth / 2, offsetTop + height);
      ctx.stroke();
    }
